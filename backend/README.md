...
## Project Structure
    ...
    ├── testdsxsdcscdeffcev_44234  # Django project configurations
...
1. Clone this repo and `cd testdsxsdcscdeffcev_44234`
...
2. Clone this repo and `cd testdsxsdcscdeffcev_44234`
